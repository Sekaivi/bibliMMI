                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('usagers.update',$usager->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" id="nom" name="nom" type="text" value="{{ $usager->nom }}" required="required" autofocus="autofocus" autocomplete="nom">
                        </div>
                        @error('nom')
                        ...
                        <div>
                            ...
                            <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" id="prenom" name="prenom" type="text" value="{{ $usager->prenom}}" required="required" autofocus="autofocus" autocomplete="prenom">
                        </div>
                        @error('prenom')
                        <p><strong>{{ $message }}</strong></p>
                        @enderror
                        ...
                        <div>
                            ...
                            <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" id="identifiant" name="identifiant" type="text" value="{{ $usager->identifiant }}" required="required" autofocus="autofocus" autocomplete="identifiant">
                        </div>
                        @error('identifiant')
                        <p><strong>{{ $message }}</strong></p>
                        @enderror
                        ...
                        <div>
                            ...
                            <select id="blocage" name="blocage" required="required" autofocus="autofocus">
                                <option value="1" {{ $usager->blocage =='1' ? 'selected' : '' }}>Oui</option>
                                <option value="0" {{ $usager->blocage =='0' ? 'selected' : '' }}>Non</option>
                            </select>
